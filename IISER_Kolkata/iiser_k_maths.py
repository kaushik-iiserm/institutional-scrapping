...
Original file is located at
    https://colab.research.google.com/drive/1M62jlzHOTs_VHoQ8xmCMHm_huwVMN137
"""
...
db = sqlite3.connect("iiserk_maths.db")
cur = db.cursor()

cur.execute(" CREATE TABLE IISERK_maths7( NAME, Research_interest)")
...
url = 'https://www.iiserkol.ac.in/web/en/people/faculty/dms/#gsc.tab=0'
...
print((all_tags[75:111])) ###the correct ones
...
cur.execute(" CREATE TABLE IISERK_maths10( NAME , Research_focus )")
...
for tag in all_tags: #[76:142] the correct one!!
    ...
    if index != 27: #exclude the 503 undispencreries.
        ...
        cur.execute("INSERT INTO IISERK_maths10  VALUES (?, ?)", faculty_detail)
...
cur.execute("SELECT * FROM IISERK_maths10")
rows = cur.fetchall()
