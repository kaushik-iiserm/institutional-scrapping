...
Original file is located at
    https://colab.research.google.com/drive/17QaKEXqFBaDthNdAxQfJ0oF9YJjbdr9i
"""
...
db = sqlite3.connect("iiserk_chem.db")
cur = db.cursor()

cur.execute(" CREATE TABLE IISERK_chem( Research_focus, background)")
...
url = 'https://www.iiserkol.ac.in/web/en/people/faculty/dcs/#gsc.tab=0'
...
print((all_tags[76:145])) ###the correct ones
...
index = 0
all_tags = all_tags[76:145]
all_tags = all_tags[1::2]

for tag in all_tags: #[76:145] the correct one!!
    index = index+1
    # print(index)
...
for tag in all_tags: #[76:142] the correct one!!
    ...
    cur.execute("INSERT INTO IISERK_chem VALUES (?, ?)", faculty_detail)
...
cur.execute("SELECT * FROM IISERK_chem")
rows = cur.fetchall()
